...
import { RootStackParamList, MainStackParamList, PaletteColor } from '../App';
...
const ColorPaletteModal = ({ navigation }: ColorPaletteModalProps) => {
  ...
  const [selectedColors, setSelectedColors] = useState<PaletteColor[]>([]);

  const handleValueChange = useCallback(
    (value: boolean, color: PaletteColor) => {
      if (value) {
